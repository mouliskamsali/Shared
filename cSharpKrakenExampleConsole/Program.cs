...
namespace cSharpKrakenExampleConsole
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            string apiPublicKey = "P/oOXrprIEdc7x347FmocKA3tjRgAhcCxUUvgcfJ+853hsNbkoZ3TNrD";
            string apiPrivateKey = "UqyfcqNkEpsmH2d1dZB7978y+gAkg7LRhfrOmCLIp5Xk0LTupE1PFW5Ajk44XffhlJltpBGwrb5deY3MeRyaog=="; 
            ...
            try
            {
                ...
                int indexFrom = webSocketRestResponseJSON.IndexOf("{\"token\":\"") + "{\"token\":\"".Length;
                int indexTo = webSocketRestResponseJSON.LastIndexOf("\",\"expires\"");

                string webSocketToken = webSocketRestResponseJSON.Substring(indexFrom, indexTo - indexFrom);
